...
return [
    ...
    | predeterminados utilizados por la clase validator. Algunas de estas
    | reglas tienen múltiples versiones, como las reglas de tamaño.
    | Siéntete libre de modificar estos mensajes.
    |
    */
    ...
    'ascii' => 'El campo :attribute solo debe contener caracteres alfanuméricos ASCII y símbolos.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ha aparecido en una filtración de datos. Por favor, elige un :attribute diferente.',
    ],
