...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Les chaînes suivantes contiennent les messages d'erreur par défaut utilisés
    | par la classe validator. Certaines règles ont plusieurs versions, comme
    | celles sur les dimensions. Vous pouvez les modifier librement.
    |
    */
    ...
    'after_or_equal' => 'Le champ :attribute doit être una date postérieure ou égale à :date.',
    ...
    'before' => 'Le champ :attribute deve être une date antérieure à :date.',
    ...
    'contains' => 'Une valeur obligatoire manque dans le champ :attribute.',
    ...
    'max' => [
        ...
        'string' => 'Le champ :attribute ne deve pas contenir plus de :max caractères.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur de :attribute est apparue dans une fuite de données. Veuillez choisir un :attribute différent.',
    ],
    ...
    'present_with_all' => 'Le champ :attribute deve être présent quand :values sont présents.',
