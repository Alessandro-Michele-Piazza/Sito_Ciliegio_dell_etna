...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Le seguenti stringhe contengono i messaggi di errore predefiniti usati
    | dalla classe validator. Alcune regole hanno più versioni, come quelle
    | sulle dimensioni. Puoi modificarle liberamente.
    |
    */
    ...
    'ascii' => 'Il campo :attribute deve contenere solo caratteri alfanumerici ASCII e simboli.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Il valore di :attribute è apparso in una violazione di dati. Scegli un :attribute diverso.',
    ],
