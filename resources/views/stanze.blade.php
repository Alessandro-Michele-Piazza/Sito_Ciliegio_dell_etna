    ...
    <div class="stanze-page">
                ...
                <div class="col-12 col-md-5 d-flex align-items-center col-text-stanze py-5 px-4 p-md-5">
                    <div class="position-relative w-100">
                        ...
                        <p class="stanze-description mb-4" data-aos="fade-up" data-aos-delay="400" data-aos-once="true">
                            {{ __('ui.Camere_matrimoniali_Descrizione') }}</p>
        ...
        <section class="container-fluid div-scacchiera px-0 overflow-hidden" data-aos="fade-left"
            ...
            <div class="row g-0 align-items-stretch">
                ...
                <!-- COLONNA TESTO -->
                <div
                    class="col-12 col-md-5 d-flex align-items-center col-text-stanze py-5 px-4 p-md-5 order-2 order-md-1">
                    <div class="position-relative w-100">
                        ...
                        <p class="stanze-description mb-4" data-aos="fade-up" data-aos-delay="400" data-aos-once="true">
                            {{ __('ui.Camere_Triple_Descrizione') }}</p>
                        <div class="amenity-row" data-aos="fade-up" data-aos-delay="500" data-aos-once="true">
                            <div class="amenity-item">
                                <i class="fas fa-snowflake scritta_verde_medio"></i>
                                <span>{{ __('ui.Aria_Condizionata') }}</span>
