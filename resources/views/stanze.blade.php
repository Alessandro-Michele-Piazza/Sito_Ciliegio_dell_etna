            ...
            <div class="col-12 col-md-5 d-flex align-items-center bg-white py-5 px-4 p-md-5  ">
                <div>
                    ...
                    <p class="testo-radici-sul-vulcano mb-5 fst-italic">
                        "Il lusso di svegliarsi nel silenzio della campagna, dove il fascino della pietra incontra
        ...
        <div class="row g-0 align-items-stretch">
            ...
            <div class="col-12 col-md-5 d-flex align-items-center bg-white py-5 px-4 p-md-5">
                <div>
                    ...
                    <p class="testo-radici-sul-vulcano mb-5 fst-italic">
                        "Il calore dell'accoglienza siciliana in ambienti spaziosi, dove ogni ospite trova la sua
                        dimensione di relax."
                    </p>
                </div>
            </div>
   ...
   <section class="container-fluid div-scacchiera px-0 overflow-hidden" data-aos="fade-right" data-aos-duration="1500"
    ...
    <div class="row g-0 align-items-stretch">
        ...
        <div class="col-12 col-md-7 h-scacchiera">
            ...
            <img src="{{ asset('storage/media/foto(2).jpg') }}" alt="Camere Quadruple Family Suite per famiglie al Ciliegio dell'Etna" class="img-scacchiera-custom"
                id="img-scacchiera">
        </div>
        ...
        <div class="col-12 col-md-5 d-flex align-items-center bg-white py-5 px-4 p-md-5">
            <div>
                ...
                <p class="testo-radici-sul-vulcano mb-5 fst-italic">
                    "L'emozione di condividere la bellezza della Sicilia in un rifugio esclusivo che profuma di storia e natura."
                </p>
            </div>
        </div>
    </div>
